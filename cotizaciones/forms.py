...
class CotizacionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'moneda_origen': forms.Select(choices=Cotizacion.MONEDAS, attrs={'class': 'form-select'}),
            'moneda_destino': forms.Select(choices=Cotizacion.MONEDAS, attrs={'class': 'form-select'}),
